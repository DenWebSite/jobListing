...
const handleSubmit = async () => {
    const updatedJob = {
        ...
        company: {
            ...
            contanctEmail: form.company.contanctEmail,
            contanctPhone: form.company.contanctPhone,
        }
    };
    ...
    try {
        ...
        toast.error('Job was not updated succesfully');
    }
}
...
onMounted(async () => {
    try {
        ...
        form.company.contanctEmail = state.job.company.contanctEmail;
        form.company.contanctPhone = state.job.company.contanctPhone;
            ...
            <div class="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
                <form @submit.prevent="handleSubmit">
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.company.contanctEmail" type="email" id="contact_email" name="contact_email"
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.company.contanctPhone" type="tel" id="contact_phone" name="contact_phone"
